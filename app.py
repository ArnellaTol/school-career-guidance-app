...
# st.set_page_config(
#     page_title="Career guidance for students",
# )
...
def translate(text, lang, **kwargs):
    translated_text = translations.get(lang, {}).get(text, text)
    
    if isinstance(translated_text, dict) and text == 'checkbox_columns':
        return [translated_text.get(item, item) for item in checkbox_columns]
    
    return translated_text.format(**kwargs)


if 'lang' not in st.session_state:
    st.session_state.lang = 'russian' # english, kazakh, russian

# Language selection (working on it)
# selected_lang = option_menu(
#     menu_title=None,
#     options=['English', 'Қазақша', 'Русский'],
...
elif selected_lang == 'Қазақша':
    st.session_state.lang = 'kazakh'
else:
...
# base="light"
# primaryColor="#946bff"
# secondaryBackgroundColor="#f8f4fd"
# textColor="#3a3248"
...
# base="light"
# primaryColor="#548aef"
# secondaryBackgroundColor="#f1f6fd"
# textColor="#263354"
