...
type_labels = {
    "А": {"ru": "Активист", "en": "Activist", "kz": "Белсенді"},
    "Т": {"ru": "Творец", "en": "Creator", "kz": "Шығармашыл"},
    "П": {"ru": "Проектировщик", "en": "Planner", "kz": "Жоспарлаушы"},
    "К": {"ru": "Карьерист", "en": "Careerist", "kz": "Мансапқор"},
    "Ип": {"ru": "Испытатель", "en": "Challenger", "kz": "Сынаушы"},
    "Ил": {"ru": "Исследователь", "en": "Researcher", "kz": "Зерттеуші"}
}

# Вопросы: текст на 3 языках + коды
questions = [
    {
    ...
    {
        "ru": "Ты переживаешь, когда учитель ставит плохую отметку?",
        "en": "Do you worry when a teacher gives you a bad grade?",
        "kz": "Мұғалім жаман баға қойғанда уайымдайсың ба?",
        "codes": ["А"]
    },
    {
        "ru": "Ты переживаешь, когда находишь ошибки в своей работе?",
        "en": "Do you worry when you find mistakes in your work?",
        "kz": "Жұмысыңнан қателер тапқанда уайымдайсың ба?",
        "codes": ["А"]
    },
    {
        "ru": "Трудности выбивают тебя из колеи?",
        "en": "Do difficulties usually knock you off track?",
        "kz": "Қиындықтар сені жолдан тайдыра ма?",
        "codes": ["А", "Т"]
    },
    {
        "ru": "Из-за неудачи ты оставляешь работу незаконченной?",
        "en": "Do you sometimes leave work unfinished because of failure?",
        "kz": "Сәтсіздікке байланысты жұмысты аяқтамай қалдырасың ба?",
        "codes": ["А", "П"]
    },
    {
        "ru": "Тебе нравится выполнять сложные поручения?",
        "en": "Do you like handling challenging tasks?",
        "kz": "Күрделі тапсырмаларды орындағанды ұнатасың ба?",
        "codes": ["А"]
    },
